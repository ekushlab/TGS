...
export const DEFAULT_SETTINGS: AppSettings = {
  ...
  societySubtitle: "আস্থার সাথে অগ্রগতির যাত্রা",
  societySubtitleEn: "From Trust to Prosperity",
...
export const METHODS = ["হাতে নগদ", "বিকাশ", "নগদ (মোবাইল)", "রকেট", "ব্যাংক ডিপোজিট", "বাংলা কিউআর"];
