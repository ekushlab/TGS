...
⚠️ সতর্কতা: এই ক্রেডেনশিয়াল অত্যন্ত গোপনীয়। এটি কারো সাথে শেয়ার করবেন না।`;
  ...
  const handleCopy = () => {
    ...
    const cred: GeneratedCredential = {
      id: `cred-${Date.now()}`,
      name: personName || "অ্যাডমিন কর্মকর্তা",
      phone: personPhone,
      role: selectedRole,
  ...
  const handleGenerateBulk = () => {
    const list: GeneratedCredential[] = members.map((m, idx) => {
      ...
      const roleTitle = isExec ? "নির্বাহী সদস্য (Executive Admin)" : "সাধারণ সদস্য (Member)";
      ...
      <div className="bg-white rounded-2xl max-w-3xl w-full p-5 sm:p-6 shadow-2xl border border-stone-200 my-6 space-y-5 max-h-[92vh] overflow-y-auto relative">
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  <option value="">-- নতুন ব্যক্তির জন্য বা ম্যানুয়াল এন্ট্রি --</option>
                  {members.map((m) => (
              ...
              {selectedRole === "custom" && (
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="যেমন: সমন্বয়কারী / বিশেষ উপদেষ্টা"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="যেমন: মোহাম্মদ মোস্তফা কামাল"
                  className="w-full bg-stone-50 border border-stone-300 rounded-xl px-3 py-2 text-xs text-stone-800"
                />
              </div>
            ...
            <div className="bg-stone-50 border border-stone-200 p-3.5 rounded-xl space-y-3">
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    জটিল আলফানিউমেরিক (High Security)
                  </button>
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className="flex items-start justify-between gap-3 border-b border-emerald-800/80 pb-3">
                  <div>
                    ...
                    <p className="text-xs text-emerald-200/90">
                      পদবী: <strong className="text-amber-200">{getRoleTitle(selectedRole)}</strong>
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    title="পুনরায় আইডি ও পাসওয়ার্ড তৈরি করুন"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-1">
                  ...
                  <div className="bg-emerald-950/80 border border-emerald-700/80 rounded-xl p-3 space-y-1">
                    ...
                    <span className="text-[9px] text-emerald-400/80 block">
                      * শক্তিশালী এনক্রিপ্টেড সিকিউরিটি
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-emerald-900/60 rounded-xl p-2.5 border border-emerald-800 text-xs flex flex-wrap items-center justify-between gap-2 text-emerald-200 font-mono">
                  <span>
                    প্রাপক: <strong className="text-white">{personName || "অ্যাডমিন কর্মকর্তা"}</strong>
                  </span>
                  <span>
                    তারিখ: <strong className="text-white">{new Date().toLocaleDateString("en-GB")}</strong>
                  </span>
                  <span>
                    স্ট্যাটাস: <strong className="text-amber-300">Active Credential</strong>
                  </span>
                </div>
        ...
        {activeTab === "bulk" && (
          <div className="space-y-4">
            <div className="bg-amber-50 border border-amber-200 p-3.5 rounded-xl text-xs text-amber-950 flex items-start gap-2.5">
              ...
              <div>
                <p className="font-bold">বাল্ক জেনারেটর নির্দেশিকা:</p>
                <p className="text-[11px] text-amber-900 mt-0.5">
                  সোসাইটির সকল সদস্য ও কার্যনির্বাহী কমিটির জন্য স্বয়ংক্রিয়ভাবে এক ক্লিকে ইউজার আইডি এবং নিরাপদ পাসওয়ার্ড তৈরি করা হয়েছে। আপনি সম্পূর্ণ তালিকা এক্সেল অথবা প্রিন্ট আকারে সংরক্ষণ করতে পারবেন।
                </p>
              </div>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse">
                <thead className="bg-stone-100 text-stone-700 font-bold sticky top-0 border-b border-stone-200">
                  <tr>
                    ...
                    <th className="p-2.5">পদবী / ভূমিকা</th>
                    <th className="p-2.5 font-mono">ইউজার আইডি</th>
                    <th className="p-2.5 font-mono">পাসওয়ার্ড</th>
                    ...
                    <tr key={item.id} className="hover:bg-stone-50">
                      ...
                      <td className="p-2.5 text-center">
                        <button
                          type="button"
                          onClick={() => {
                            const slip = `🏢 ${settings.societyName || "TRUST GROWTH SOCIETY"}\n👤 নাম: ${item.name}\n🏷️ পদবী: ${item.roleTitle}\n🆔 আইডি: ${item.userId}\n🔑 পাসওয়ার্ড: ${item.password}`;
                            navigator.clipboard.writeText(slip);
                            alert(`'${item.name}' এর ক্রেডেনশিয়াল কপি করা হয়েছে!`);
                          }}
        ...
        {activeTab === "history" && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-stone-700">
                পূর্বে তৈরি করা ক্রেডেনশিয়াল রেকর্ড ({formatNumber(history.length)} টি)
              </span>
              ...
              {history.length > 0 && (
                <button
                  type="button"
                  onClick={() => {
                    if (window.confirm("আপনি কি সমস্ত ক্রেডেনশিয়াল হিস্ট্রি মুছে ফেলতে চান?")) {
                      setHistory([]);
            ...
            {history.length === 0 ? (
              <div className="text-center py-10 bg-stone-50 rounded-xl border border-dashed border-stone-200 text-stone-500 text-xs">
                ...
                <p className="font-bold">এখনো কোনো হিস্ট্রি সংরক্ষিত হয়নি</p>
                <p className="text-[11px] mt-0.5">একক ক্রেডেনশিয়াল জেনারেট করে কপি করলে স্বয়ংক্রিয়ভাবে এখানে সংরক্ষিত থাকবে।</p>
              </div>
            ) : (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          const text = `🏢 ${settings.societyName || "TRUST GROWTH SOCIETY"}\n👤 নাম: ${h.name}\n🏷️ পদবী: ${h.roleTitle}\n🆔 আইডি: ${h.userId}\n🔑 পাসওয়ার্ড: ${h.password}`;
                          navigator.clipboard.writeText(text);
                          alert(`'${h.name}' এর ক্রেডেনশিয়াল কপি করা হয়েছে!`);
                        }}
